...
import { FaPlus, FaTrash, FaSave, FaTimes, FaArrowLeft, FaUpload } from 'react-icons/fa';
          ...
          <main className={`transition-all duration-300 flex-1 p-6 overflow-y-auto h-[90vh] ${
            ...
            <div className="flex justify-center items-center h-full">
              <div className="text-center">
                ...
                <p className="mt-4 text-xs font-bold uppercase tracking-widest text-gray-500">Loading deposit method...</p>
              </div>
            </div>
          </main>
        </div>
              ...
              <div className="bg-[#1C2128] px-6 py-5 border-b border-gray-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-gray-500 mt-1 flex items-center gap-2">
                    Update {formData.gatewayName || 'Gateway'} details and configuration
                  </p>
                </div>
                <button
                  type="button"
                  onClick={() => navigate('/payment-method/all-deposit-method')}
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-[10px] font-black uppercase tracking-widest text-amber-400">Gateway Image</h2>
                  </div>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    <div className="relative w-32 h-32 bg-[#0F111A] border-2 border-dashed border-gray-700 rounded-lg flex items-center justify-center hover:border-amber-500 transition-colors group">
                      {(uploadedImage || existingImage) ? (
                        ...
                        <AiOutlineCamera className="text-gray-600 text-3xl group-hover:text-amber-400 transition-colors" />
                      )}
                      <input
                        type="file"
                        accept="image/*"
                    ...
                    <div>
                      <p className="text-xs text-gray-500">Click the box to upload a new image</p>
                      <p className="text-[10px] text-gray-600 mt-1">Recommended: 200x200px PNG or JPG</p>
                      {existingImage && !uploadedImage && (
                        <p className="text-[10px] text-amber-400 mt-2 flex items-center gap-1">
                          <FaUpload className="text-[9px]" /> Current image will be replaced on upload
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                      <label className={labelClass}>Gateway Name <span className="text-rose-400">*</span></label>
                      <input
                        type="text"
                        name="gatewayName"
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-1 h-5 bg-amber-500 rounded-full"></div>
                    <h2 className="text-[10px] font-black uppercase tracking-widest text-amber-400">Video Tutorial (Optional)</h2>
                  </div>
                  <input
                    type="url"
                    name="youtubeLink"
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-1 h-5 bg-amber-500 rounded-full"></div>
                    <h2 className="text-[10px] font-black uppercase tracking-widest text-amber-400">Deposit Instructions</h2>
                  </div>
                  <textarea
                    ...
                    placeholder="Enter detailed deposit instructions for users..."
                  />
                </div>
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleFieldFormChange}
                        className={inputClass}
                        placeholder="e.g., Enter the 10-digit transaction number"
                      />
                    </div>
                  </div>
