...
import { FaPlus, FaTrash, FaSave, FaTimes, FaArrowLeft, FaUpload, FaDollarSign, FaPercentage, FaInfoCircle } from 'react-icons/fa';
              ...
              <div className="bg-[#1C2128] px-6 py-5 border-b border-gray-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-gray-500 mt-1 flex items-center gap-2">
                    Create a new deposit method for users
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <h2 className="text-[10px] font-black uppercase tracking-widest text-blue-400">Account Details</h2>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className={labelClass}>Account Number <span className="text-rose-400">*</span></label>
                      <input
                        type="text"
                        name="accountNumber"
                    ...
                    <div>
                      <label className={labelClass}>Account Type <span className="text-rose-400">*</span></label>
                      <select
                        name="accountType"
