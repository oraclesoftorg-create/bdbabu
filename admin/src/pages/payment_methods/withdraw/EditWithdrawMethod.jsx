...
import { FaPlus, FaTrash, FaSave, FaTimes, FaArrowLeft, FaDollarSign, FaPercentage, FaMoneyBillWave, FaYoutube } from 'react-icons/fa';
          ...
          <main className={`transition-all duration-300 flex-1 p-6 overflow-y-auto h-[90vh] ${
            ...
            <div className="flex justify-center items-center h-full">
              <div className="text-center">
                ...
                <p className="mt-4 text-xs font-bold uppercase tracking-widest text-gray-500">Loading withdrawal method...</p>
              </div>
            </div>
          </main>
        </div>
              ...
              <div className="bg-[#1C2128] px-6 py-5 border-b border-gray-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-gray-500 mt-1 flex items-center gap-2">
                    Update {formData.gatewayName || 'Gateway'} withdrawal details
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="bg-[#0F111A] border border-gray-800 rounded-lg p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-[10px] font-black uppercase tracking-widest text-red-400">Video Tutorial (Optional)</h2>
                  </div>
                  <div className="relative">
                    <FaYoutube className="absolute left-3 top-1/2 -translate-y-1/2 text-red-500 text-sm" />
                    <input
                      type="url"
                      name="youtubeLink"
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  >
                    <FaSave /> UPDATE WITHDRAWAL METHOD
                  </button>
                  <button
                    type="button"
                    onClick={() => navigate('/payment-method/all-withdraw-method')}
